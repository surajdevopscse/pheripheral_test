...
abstract class BasePrinterInput extends Equatable {
  final PaperSize paperSize;

  const BasePrinterInput({this.paperSize = PaperSize.mm80});
}

extension BasePrinterInputMapping on BasePrinterInput {
  PrinterType get printerType => this is UsbPrinterInput
      ? PrinterType.usb
      : this is BluetoothPrinterInput
